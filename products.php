        ...
        <div class="<?php echo isset($_GET['c']) ? 'col-md-9' : 'col-md-12' ?>">
            ...
            <div class="container px-lg-2 mt-5">
                <div class="tab-pane fade show active" id="book">
                    ...
                    <div class="row gx-3 gx-lg-4 row-cols-1 row-cols-md-3 row-cols-xl-4">
                            ...
                            <div class="card product-item">
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <?php foreach($inv as $k=> $v): ?>
                                        <span class="price"><b>Price: </b><?php echo $v ?></span>
                                    <?php endforeach; ?>
                                </div>
                                <div class="card-footer p-3 border-0 bg-transparent">
                                    <div class="text-center">
                                        <a class="btn btn-primary btn-sm" href=".?p=view_product&id=<?php echo md5($row['id']) ?>">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
